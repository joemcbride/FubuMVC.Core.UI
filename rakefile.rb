...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Core.UI"
COPYRIGHT = 'Copyright 2012 FubuMVC.Core.UI. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Core.UI.sln', :clrversion => CLR_TOOLS_VERSION
